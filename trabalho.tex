...
Levando em consideração o nível de processamento necessário para a geração de recomendações precisas, a aplicação as excuta de forma paralela a requisição das recomendações, visando ocultar a complexidade do processo para o usuário da API. 
