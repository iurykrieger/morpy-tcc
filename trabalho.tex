...
Como forma de recomendação o motor de dados utiliza-se do \textbf{método híbrido}, composto dos métodos \textbf{baseado em conteúdo} e \textbf{filtragem colaborativa}, escalonando através do método com melhor precisão momentânea. Dessa forma é possível atender qualquer tipo de estrutura fornecida pelo usuário da API, fornecendo recomendações independente do número de usuários, itens e avaliações na base de dados.
