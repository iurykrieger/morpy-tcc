...
Para facilitar mais ainda a comunicação com o usuário da API foi criado o padrão de endpoints e retorno json... pra deixar explicita a parada...

Explicar a figura e padao de retorno JSON. Fazer um gancho pro problema dos modelos e do porque devem ser genéricos.

\begin{quadro}[h!tp]

	\caption{\label{movie_matrix}Exemplo de recurso de \textit{endpoints} para o módulo item.}
	\centering
	\begin{tabular}{|l|l|l|}
	\hline
	...
	Fonte: \citeonline{adomavicius2005toward}
...
Explicar o fluxo de funcionamento da requisição até a recomendação.
...
Explicar a figura descrita acima.

Fazer um parágrafo de introdução ao detalhamento e um resumo do overview.
