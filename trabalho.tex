...
seed.sh pra fazer o seed da movielens

Movie Lens \citeonline{harper2016movielens}

\subsection{Documentação}

criação da documentação automatica através do markdown

\subsection{Instalação e Inicialização}

criação dos scripts setup.sh e start.sh, além do update\_dependencies.sh

\subsection{Tecnologias Utilizadas} \label{tecnologias}

tabela com as tecnologias.
